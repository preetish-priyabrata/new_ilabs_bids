						...
						<!-- begin nav-tabs -->						
					  	...
					  	<div class="tab-content">
						    <div id="home" class="container tab-pane active"><br>
						    	<h3>Project details <a href="<?=base_url()?>admin-edit-user-project/<?=$value1?>/<?=$value2?>/<?=$row->job_Code?>" class="btn btn-primary btn-sm pull-right"> Edit Project Info </a></h3>
						    	<br>
						    ...
						    <div id="menu1" class="container tab-pane fade"><br>
						      <h3>Bu users list  <a href="<?=base_url()?>admin-assign-user-project/6/<?=$value1?>/<?=$value2?>/<?=$row->job_Code?>" class="btn btn-primary btn-sm pull-right"> Assign BU user </a></h3>
						      <?php 
						      	$this->db->select('*');
								    ...
								    <tbody id="myTable">
								    	...
								    	foreach ($query_bu->result() as $key_bu_user){?>
								      	...
								      	<tr>
											...
											<td><a href="<?=base_url()?>remove-users-delete-project/<?=$key_bu_user->slno_assign_project?>/<?=$value1?>/<?=$value2?>/6"  onclick="return confirm('Are you sure you want to delete this Bu user?');" >Remove user </a></td>
										</tr>
										<?php }?>
								    </tbody>
 								</table>
						    ...
						    <div id="menu2" class="container tab-pane fade"><br>
						    	  <h3>Design users list  <a href="<?=base_url()?>admin-assign-user-project/2/<?=$value1?>/<?=$value2?>/<?=$row->job_Code?>" class="btn btn-primary btn-sm pull-right"> Assign Design user </a></h3>
						      <?php 
						      	$this->db->select('*');
								$this->db->from('master_admin');
								    ...
								    <tbody id="myTable">
								    	...
								    	foreach ($query_design->result() as $key_design_user){?>
								      	...
								      	<tr>
											...
											<td><a href="<?=base_url()?>remove-users-delete-project/<?=$key_design_user->slno_assign_project?>/<?=$value1?>/<?=$value2?>/2"  onclick="return confirm('Are you sure you want to delete this Design user?');" >Remove user </a></td>
										</tr>
										<?php }?>
								    </tbody>
 								</table>
								    ...
								    <tbody id="myTable">
								    	...
								    	foreach ($query_project->result() as $key_project_user){?>
								      	...
								      	<tr>
											...
											<td><a href="<?=base_url()?>remove-users-delete-project/<?=$key_project_user->slno_assign_project?>/<?=$value1?>/<?=$value2?>/3"  onclick="return confirm('Are you sure you want to delete this Project user?');" >Remove user </a></td>
										</tr>
										<?php }?>
								    </tbody>
 								</table>
						    ...
						    <div id="menu4" class="container tab-pane fade"><br>
						     	  <h3>Procurement users list  <a href="<?=base_url()?>admin-assign-user-project/4/<?=$value1?>/<?=$value2?>/<?=$row->job_Code?>" class="btn btn-primary btn-sm pull-right"> Assign Procurement user </a></h3>
						      <?php 
						      	$this->db->select('*');
								$this->db->from('master_admin');
								    ...
								    <tbody id="myTable">
								    	...
								    	foreach ($query_procurement->result() as $key_procurement_user){?>
								      	...
								      	<tr>
											...
											<td><a href="<?=base_url()?>remove-users-delete-project/<?=$key_procurement_user->slno_assign_project?>/<?=$value1?>/<?=$value2?>/4"  onclick="return confirm('Are you sure you want to delete this Procurement user?');">Remove user </a></td>
										</tr>
										<?php }?>
								    </tbody>
 								</table>
						    ...
						    <div id="menu5" class="container tab-pane fade"><br>
						      	  <h3>Buyer users list  <a href="<?=base_url()?>admin-assign-user-project/7/<?=$value1?>/<?=$value2?>/<?=$row->job_Code?>" class="btn btn-primary btn-sm pull-right"> Assign Buyer user </a></h3>
						      <?php 
						      	$this->db->select('*');
								$this->db->from('master_admin');
								    ...
								    <tbody id="myTable">
								    	...
								    	foreach ($query_buyer->result() as $key_buyer_user){?>
								      	...
								      	<tr>
											...
											<td><a href="<?=base_url()?>remove-users-delete-project/<?=$key_buyer_user->slno_assign_project?>/<?=$value1?>/<?=$value2?>/7"  onclick="return confirm('Are you sure you want to delete this Buyer?');">Remove user </a></td>
										</tr>
										<?php }?>
								    </tbody>
 								</table>
						    </div>
						    <a  href="<?=base_url()?>admin-view-project" class="btn btn-grey pull-right">Back</a>
					  </div>
