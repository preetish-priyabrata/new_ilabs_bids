...
// $result_drafted=$this->comm_eva_db->commerical_evalutor_get_bid_information($value);
// $result_vendor_list=$this->comm_eva_db->commerical_evalutor_get_vendor_information($value);// vendor information
...
$mr_slno=$bid_list->mr_slno;
	...
	$commerical_evalution=$get_mr_id['mr_details'][0]->commerical_evalution;
									...
									<div class="row">
										...
										<div class="col-md-6 col-lg-6">
											...
											<div class="form-group row m-b-15">
												...
												<div class="col-md-9">
													<input class="form-control-plaintext m-b-5" placeholder="Enter Bid Ref No" name="bid_ref_no" id="bid_ref_no" type="text" required=""value="<?=$bid_list->bid_ref_no?>">
