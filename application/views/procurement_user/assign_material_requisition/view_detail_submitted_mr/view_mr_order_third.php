...
<div id="content" class="content">
	...
	<ol class="breadcrumb pull-right">
		...
		<li class="breadcrumb-item active">Assign Material Requisition</li>
	</ol>
	<!-- end breadcrumb -->
	<!-- begin page-header -->
						...
						<div class="form-group row m-b-15">
							...
							<div class="col-md-9">
								<?php
									...
									$result_drafted=$this->procurement_user->procurement_mr_receive_list($email_id,'1',$value);
										...
										if($status_mr!=1){
											if ($result_drafted['no_received']==2) {
												...
												if ($result_drafted['received_list'][0]->Forward_status==2) {
