...
<div class="sidebar-bg"></div>
		...
		<div id="content" class="content">
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header"> View Approved Material Requisition </h1>
			<!-- end page-header -->
					        	...
					        	<?php 
					        		...
					        		foreach ($result_drafted['received_list'] as $value_list) {
					        			...
					        			switch ($value_list->materilal_category_id_slno) {
											case '1':
						                		if($Status==1){
						                            $view=('approver-new-mr-order-approved-view/'.$last_id.'/'.'1/'.$last_id);
						                        }else{
						                        	$view="#";
						                        }				                                    
						                        break;
						                    case '2':
						                        if($Status==1){
						                            $view=('approver-new-mr-order-approved-view/'.$last_id.'/'.'2/'.$last_id);
						                        }else{
						                            $view="#";
						                        }
			                                    break;
						                    case '3':
						                        if($Status==1){
						                            $view=('approver-new-mr-order-approved-view/'.$last_id.'/'.'3/'.$last_id);
						                        }else{
						                            $view="#";
						                        }	                                    
			                                    break;
					        		...
					        		<tr>
						                ...
						                <td><?=$value_list->mr_forword_date?></td>
						                <td><?php 
						                
						                		$slno_mr=$value_list->slno_mr; 
						                		$get_approved=$this->approver_user->get_approver_conform_mr_job_detail($slno_mr);
						                		if($get_approved['no_mr_deatils']==1){
						                			...
						                			echo $Username_get_Procurement_id=$get_Procurement_id['list_user'][0]->Username;
						                		}
						                ?></td>     
	                                   <td><a href="<?=$view?>" class="btn btn-purple btn-xs">View More</a></td>   
	                                   <!-- <td></td> -->
