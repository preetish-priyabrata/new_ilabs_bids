...
var queryString = "";
	if(action != "") {
		switch(action) {
			...
			if($("#location_from_"+item_codes_order).val()!=""){
				if($("#location_to_"+item_codes_order).val()!=""){
					if($("#purpose_"+item_codes_order).val()!=""){
						queryString = 'action=add_re_vehcile&code='+ item_codes_order+'&quantity='+$("#qty_"+item_codes_order).val()+'&from_location='+$("#location_from_"+item_codes_order).val()+'&to_location='+$("#location_to_"+item_codes_order).val()+'&purpose='+$("#purpose_"+item_codes_order).val();
					}else{
			...
			break;
			case "remove":
				queryString = 'action=remove_re_vechile&code='+ item_codes_order+'&codes_value='+value;
			break;
			case "empty":
...
function cart_active(){
    	...
    	var Mr_no = $('#Mr_no').val();
		var slno_Mr_no = $('#slno_Mr_no').val();
		queryString_id = 'actions_file='+actions_file+'&Mr_no='+ Mr_no+'&slno_Mr_no='+slno_Mr_no+'&action=add_vechile_re_vechile';
