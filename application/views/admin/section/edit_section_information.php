...
<div class="sidebar-bg"></div>
		...
		<div id="content" class="content">
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Edit Section Form </h1>
			<!-- end page-header -->
			...
			<div class="panel panel-inverse">
				<div class="panel-heading">
					...
					<h4 class="panel-title">Edit Section Information</h4>
				</div>
				<div class="panel-body">
					<div class="alert alert-secondary">
                    	<span style="color: red"> *</span> All mandory fields shall be duly filled up 
                    </div>
					<form action="<?=base_url()?>admin-edit-section-save" method="POST" >						
						...
						<div class="row">
							<div class="col-md-6 col-lg-6">
							 	<div class="form-group row m-b-15">
									...
									<div class="col-md-9">
										<input class="form-control m-b-5" placeholder="Enter Section name" name="Section_name" id="Section_name" type="text" required="" value="<?=$row->section_Name?>">
