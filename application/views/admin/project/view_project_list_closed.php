...
<div class="sidebar-bg"></div>
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="breadcrumb-item active">View Closed Project  Lsit</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">View Closed Project  List </h1>
			<!-- end page-header -->
			...
			<?php 
			 ...
			 <div class="panel panel-inverse">
				<div class="panel-heading">
					...
					<h4 class="panel-title">Closed Project List</h4>
				</div>
				<div class="panel-body">
					...
					<ul class="nav nav-tabs nav-justified">
					  <li class="nav-item">
					    <a class="nav-link " href="<?=base_url()?>admin-view-project">On going Project</a>
					  </li>
					  <li class="nav-item">
					    <a class="nav-link active" data-toggle="tab" href="#">Closed Project</a>
					  </li>
									                ...
									                <td>
									                	<div class="btn-group">
														  ...
														  <ul class="dropdown-menu pull-right">
														  	<li><a href="admin-project-view-details-complete/<?=$user_id?>/<?=$slno_id?>" > view </a></li>
