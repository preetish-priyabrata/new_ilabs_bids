...
<div class="sidebar-bg"></div>
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="breadcrumb-item active">View vehicle capacity List</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			 ...
			 <div class="panel panel-inverse">
				...
				<div class="panel-body">
					...
					<div class="pull-right">
						<a href="admin-add-vehicle-capacity" class="btn btn-info fa fa-puzzle-piece " role="button" title="here new vehicle is been created">  New vehicle Capacity info</a>
					</div>
					<br>
					<br>
					        ...
					        <tbody>
					        		...
					        		foreach ($query->result() as $value) {
					        			...
					        			<tr>
							                ...
							                if($Status==1){
							                	echo "<a href='change-vehicle-capacity-status/".$user_id."/".$slno_id."/1' class='btn btn-outline-primary btn-sm'>Active vehicle</a>";
							                }else if($Status==2){
							                	echo "<a href='change-vehicle-capacity-status/".$user_id."/".$slno_id."/2' class='btn btn-outline-warning btn-sm'>In-active vehicle </a>";
							                }elseif ($Status==3) {
							                ...
							                <td>
							                	...
							                	<div class="btn-group">
												  ...
												  <ul class="dropdown-menu pull-right">											  	
												  	...
												  	<li class="divider"></li>
												  	<li><a <?php echo "href='change-vehicle-capacity-status/".$user_id."/".$slno_id."/3' ";?> onclick="return confirm('Are you sure you want to delete this vehicle?');">Delete</a></li>
												  </ul>
												</div>
												<?php }?>
					...
					<br>
					<?php 
					$get_type_vehicle=$this->user->admin_get_vechile_capacity();
		...
		<?php 
		if($get_type_vehicle['vehicle_capacity']=='1'){

			foreach ($get_type_vehicle['vehicle_capacity_list'] as $key_vehicle) {
								...
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-header">
											<h4 class="modal-title">Edit Vehicle Capacity Information</h4>
											<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
										</div>
										<form action="admin-edit-vehicle-capacity-save" method="POST" >
											<input  name="type_slno" id="type_slno" type="hidden" value="<?=$key_vehicle->Slno_vehicle?>" required="">
											<div class="modal-body">
												<div class="form-group row m-b-15">
													<label class="col-form-label col-md-3" for="type_of_name">Capacity of vehicle <span style="color: red">*</span></label>
													<div class="col-md-9">
														<input class="form-control m-b-5"  placeholder="Enter type of vehicle " name="type_of_name" id="type_of_name" type="text" value="<?=$key_vehicle->vehicle_capacity?>" required="">
