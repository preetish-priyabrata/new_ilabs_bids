...
$resutl=$this->user->get_bu_trackinh(1,'');
					        	...
					        	<tr>
					        		...
					        		<td><?php 
						        		if($submitted_by==$email_id){
						        			...
						        			?>
						        			<a href="bu-view-tracking-tool/<?=$Slno_tracking?>" class="btn btn-purple btn-sm">View Details</a>
						        			<a href="bu-view-edit-tracking-tool/<?=$Slno_tracking?>" class="btn btn-purple btn-sm">Edit Details</a>
						        			<?php 
						        		}else{
						        			echo "---";
						        		}
