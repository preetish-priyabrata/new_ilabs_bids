...
$value1=$value1;
$result_drafted=$this->buyer_user->drafted_bid_information($email_id,4,$value);
...
// Bid Detail Dates
$result_drafted_dates=$this->buyer_user->drafted_bid_information_DATE($Slno_bid,4);
$value_bid_dates=$result_drafted_dates['bid_date_list'][0]; // bid dates
// Bid Detail Information
$result_drafted_bid_details=$this->buyer_user->drafted_bid_information_details($Slno_bid,4);
$value_bid_details=$result_drafted_bid_details['bid_details_list'][0]; // bid details
//bid vendor inserted
$result_drafted_bid_details_vendor = $this->buyer_user->drafted_bid_vendor_information_details($Slno_bid,4);
