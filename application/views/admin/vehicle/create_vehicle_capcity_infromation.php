						...
						<div class="row">
							<div class="col-md-6 col-lg-6">
							 	...
							 	<div class="form-group row m-b-15">
									...
									<div class="col-md-9">
										<input class="form-control m-b-5" onkeyup="get_id_vechile_type()" placeholder="Enter capacity of vehicle " name="type_of_name" id="type_of_name" type="text" required="">
...
<script type="text/javascript">
	function get_id_vechile_type() {
		...
		var action_id="vechile_capacity_info";
		if(type_of_name!=""){
			$('#save').hide();
