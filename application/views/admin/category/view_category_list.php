			 ...
			 <div class="panel panel-inverse">
				...
				<div class="panel-body">
					...
					<div class="pull-right">
						<a href="admin-add-category" class="btn btn-info fa fa-puzzle-piece " role="button" title="hre new Category is been created">  New Category</a>
					</div>
					<br>
					<br>
					<div class="table-responsive-sm">
						<table id="example" class="display" style="width:100%">
					        ...
					        <tbody>
					        		<?php 
					        		$x=0;
					        		// `Slno_cat`, `category_name`, `category_id`, `category_desc`, `short_code`, `status`
					        		$table='master_category';
					        		$query=$this->db->get($table);
					        		foreach ($query->result() as $value) {
					        			
					        			$slno_id=$value->Slno_cat;
					        			...
					        			<tr>
							                ...
							                if($Status==1){
							                	echo "<a href='change-category-status/".$user_id."/".$slno_id."/1' class='btn btn-outline-primary btn-sm'>Active Category</a>";
							                }else if($Status==2){
							                	echo "<a href='change-category-status/".$user_id."/".$slno_id."/2' class='btn btn-outline-warning btn-sm'>In-active Category</a>";
							                }elseif ($Status==3) {
							                	echo "<a href='#' class='btn btn-danger btn-sm'>Deleted Category</a>";
							                }else{
							                	echo "--";
							                }
							                ...
							                <td>
							                	...
							                	<div class="btn-group">
												  ...
												  <ul class="dropdown-menu pull-right">											  	
												  	<li><a   <?php echo "href='edit-category-info/".$user_id."/".$slno_id."'";?> >Edit </a></li>
												  	<li class="divider"></li>
