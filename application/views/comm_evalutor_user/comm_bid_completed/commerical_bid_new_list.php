...
$list_success_bid=$this->comm_eva_db->commerical_evaluator_bid_completed_list($comm_slno);
...
<div class="sidebar-bg"></div>
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="breadcrumb-item"><a href="javascript:;">Commercial Bid New</a></li>
				<li class="breadcrumb-item active">List of Commercial Bid New List</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">List of Commercial Bid New</h1>
			<!-- end page-header -->
			...
			//  print_r($list_success_bid);
			 ...
			 <div class="panel panel-inverse">
				<div class="panel-heading">
					...
					<h4 class="panel-title">Commercial Bid New List</h4>
				</div>
					        ...
					        <tbody>
					        	<?php
					        		...
					        		<tr>
					        			...
					        			<td><?=$bid_key_id->material_category_name?></td>
					        			<td><?=$bid_key_id->mode_bid?></td>
					        			<td><?php
		                                    $status_bid=$bid_key_id->status_bid;
		                                    if($status_bid==6){
		                                    	echo "<p style='color:green'>Bid Is Completed</p>";
		                                    }else{
		                                    	echo "Not Completed";
		                                    }
		                                 ?>
