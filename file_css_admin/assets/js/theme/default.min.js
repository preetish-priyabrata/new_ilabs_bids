...
// $('head').append('<link href="https://stackpath.bootstrapcdn.com/bootstrap/4.1.0/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-9gVQ4dYFwwWSjIDZnLEWnxCjeSWFphJiwGPXr1jddIhOegiu1FwO5qRGvFXOdJZ4" crossorigin="anonymous">');
// // $('link[href="mycustom.css"]').prop('disabled', true)
$('link[href="../assets/plugins/font-awesome/5.0/css/fontawesome-all.min.css"]').remove();
// $('link[href="../assets/plugins/bootstrap/4.1.0/css/bootstrap.min.css"]').remove();
