...
$value1=$value1;
$result_drafted=$this->buyer_user->drafted_bid_information_commerical($email_id,4,$value);
...
$result_drafted_bid_details=$this->buyer_user->drafted_bid_information_details_commerical($Slno_bid,4);
$value_bid_details=$result_drafted_bid_details['bid_details_list'][0]; // bid details
//bid vendor inserted
$result_drafted_bid_details_vendor = $this->buyer_user->drafted_bid_vendor_information_details_commerical($Slno_bid,4);
		...
		<div class="panel-body">
			...
			<form action="<?=base_url()?>bid-tech-entry" method="POST"  id="bid_tech" name="bid_tech" class="bid_tech">
													...
													<div class="col-lg-12">
														<table class="table table-bordered" cellpadding="10" cellspacing="1" width="100%">
															...
															?>
																				...
																				<td>		                                    	<p>
																						Vendor Name : <?=$key_vendors->Vendor_name?>
																					</p>
																					<p>
				...
				<div class="form-group row pull-right">
                    <div class="col-md-12">
											<a  href="<?=base_url()?>user-buyer-conform-send/<?=$value?>/2" class="btn btn-sm btn-success"  onclick="return confirm('Are you sure you want to Sent this Bid?');"> Do You Want send Commerical Bid ?</a>
